// Chat list screen for candidates
    ...
    useEffect(() => {
        ...
        const loadChatRooms = async () => {
            try {
                ...
                // For candidate screens, use 'candidate' as userType
                    ...
                    <View style={styles.nameRow}>
                        <View style={styles.nameContainer}>
                            <Text style={styles.name} numberOfLines={1}>
                                {item.otherParticipantName || 'Nhà tuyển dụng'}
                            </Text>
                            {item.company && (
            ...
            {loading ? (
                ...
                <View style={styles.centerContainer}>
                    ...
                    <Text style={styles.emptySubtext}>
                        Hãy ứng tuyển các công việc để bắt đầu trò chuyện.
                    </Text>
                    <Button 
                        mode="contained" 
                        style={styles.button}
