# Generated by Django 5.1.6 on 2025-04-14 15:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Quản trị viên'), ('recruiter', 'Nhà tuyển dụng'), ('candidate', 'Ứng viên')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specialized', models.CharField(default='Chưa phân loại', max_length=100)),
                ('description', models.TextField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Chờ duyệt'), ('approved', 'Đã duyệt'), ('rejected', 'Bị từ chối')], default='pending', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Đang chờ duyệt'), ('accepted', 'Đã chấp nhận'), ('rejected', 'Đã từ chối')], default='pending', max_length=20)),
